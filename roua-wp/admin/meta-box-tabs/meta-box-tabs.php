...
if ( ! class_exists( 'RWMB_Tabs' ) )
{
	class RWMB_Tabs
	{
		...
		function admin_enqueue_scripts()
		{
			...
			wp_enqueue_style( 'rwmb-tabs', THEMEROOT . '/admin/metaboxes/meta-box-tabs/tabs.css' );
			wp_enqueue_script( 'rwmb-tabs', THEMEROOT . '/admin/metaboxes/meta-box-tabs/tabs.js', array( 'jquery' ), '0.1', true );
		}
